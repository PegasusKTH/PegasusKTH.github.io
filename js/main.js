  ...
  try {
    ...
    //turns json into a workable object
      ...
      //finds all coursecodes in the required courses string
          //do the splittysplit on req and rec courses
          re

      var i;
      // var reqArray = new Array();
      // var reqs  = requiredCourse.match(/[A-Z][A-Z][0-9][0-9][0-9][0-9]/g);
      // console.log(reqs);
      var reqArray = requiredCourse.match(/[A-Z][A-Z][0-9][0-9][0-9][0-9]/g); //reqs;
      ...
      // var recs  = recommendedCourse.match(/[A-Z][A-Z][0-9][0-9][0-9][0-9]/g);
      // console.log(recs);
      var recArr = recommendedCourse.match(/[A-Z][A-Z][0-9][0-9][0-9][0-9]/g);//recs;
